...
grid.arrange(plot_size_dpt, plot_size_total, ncol = 2, 
             main = "Size of companies that nominated a CIL representative",
             bottom = "Measured by number of workers (in logs). Left graph gives size of the establishment and right graph gives size of the entire company. In many cases, these will be equivalent, but large companies will have multiple establishments.")
```
